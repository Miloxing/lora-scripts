...
pretrained_model="./sd-models/model2.safetensors" # base model path | 底模路径
...
output_name="hll_sd1.5_r5_v1"           # output model name | 模型保存名称
...
# 远程记录设置
use_wandb=1 # use_wandb | 启用wandb远程记录功能
wandb_api_key="15441b8e4eeaf36dcf694dc0c69205b0f5416a10" # wandb_api_key | API,通过https://wandb.ai/authorize获取
